...
| | | | | | | | | | | | | | | | | | |
|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|-|
|Title|Category|journal|Year|Sub Domain|Problem Addressed|Proposed Solution|Techniques|Input Features|Output Variables|RMSE, MAE, MAPE, Accuracy|Evaluation Measures|Data Set|Analysis|Research Gap|Future Directions|Any other notes|One Paragraph Summary|
|Traffic Forecasting using Time-Series Analysis| | |2021|Time Series Analysis|To forecast traffic flow |Using Time Series analysis Along with statistical model and algorithms |ARIMA SARIMA LSTM HYBRID MODEL|Lower Mean Absolute Error and Root mean square Error + Improved Accuracy 90%| | |RMSE MAE Accuracy Prediction|Real World Traffic Data| | | | |The paper on traffic forecasting using time-series analysis presents a comprehensive study on predicting traffic patterns through the application of time-series analysis techniques. Authored by researchers from BRAC University, the study explores the use of historical traffic data to develop forecasting models for future traffic conditions. With a focus on real-world applications, the paper discusses the implications of utilizing time-series analysis in traffic management scenarios. While the specific dataset and evaluation measures are not explicitly mentioned, the paper highlights the importance of data-driven approaches in understanding and predicting traffic behavior. Overall, the research contributes valuable insights into the field of traffic forecasting and underscores the significance of leveraging data analytics for effective traffic management strategies.|
|Hybrid Time Series Forecasting Model for Traffic Flow Prediction | | |2022|Time Series Forecasting|To accuractely forecasting traffic pattern |Using Hybrid Model |ARIMA- MLP ARIMA-RNN  |MAE MSE RMSE Error reduction as compared to others| | |MAE MSE RMSE Graphical Analysis|UK Highways dataset, specifically from the MIDAS Site| |Study shows that by integrating linear and nonlinear models to enhance the selection of inherent features in time-series data​|forecasting models with bio-inspired optimization techniques  To Improve accuracy and efficiency| |The research paper is on “Hybrid Time-Series Forecasting Models for Traffic Flow Prediction” which aims at predicting traffic flow accurately; this is important for intelligent transportation systems. In order to use both linear and nonlinear data patterns, the authors have proposed hybrid models that combine ARIMA with MLP and RNN. It was observed that the dataset used in the UK Highways (MIDAS Site – 5,825) from January to June 2020 for training and July 2020 for testing. Comparatively with MAE, MSE, RMSE and R² as performance metrics; the residual errors are greatly reduced by hybrid models than standalone ARIMA, MLP and RNN models resulting in higher accuracy. The study further reveals some research gaps towards model accuracy, computational complexity and irregular traffic patterns despite these improvements. Possible future research directions involve utilizing bio-inspired optimization techniques to enhance forecasting of traffic flow.|
|HYBRID TIME-SERIES FORECASTING MODELS FOR TRAFFIC FLOW PREDICTION| | |2020|Real Time Data Analysis Forecasting|To accuractely forecasting future analysis of Web Traffic|Integrate DWT , ARIMA, LSTM RNN| DWT ARIMA  LSTM RNN f Combining Forecasts| | | |MAE RMSE MAPE |Wikipedia’spageviewAPI| |highlights the challenges and complexities involved in accurately forecasting web traffic  more efficient and effective techniques that can handle the high variability and noise in web traffic data.  |exploration of multivariate time series forecasting  enhancing the accuracy  real-time scenarios| |A paper named “Web Traffic Time Series Forecasting using ARIMA and LSTM RNN” by Tejas Shelatkar et al. examines the web traffic predictions made based on Autoregressive Integrated Moving Average (ARIMA) and Long Short Term Memory Recurrent Neural Network (LSTM RNN) models. The study shows that accurate web traffic predictions are crucial for efficient utilization and to avoid server down time. To demonstrate this, the research integrates these models through the inverse discrete wavelet transformation (iDWT), which improves forecast accuracy. It is possible to anticipate future numbers of users who will access websites with refinements in more user data as indicated in the final word of this piece. These directions could help better handle congestion control and decision-making processes by exploring multivariate time series forecasting thereby simplifying real-time decision making through past values predicting future trends. Therefore, with deep learning and traditional models’ combination, it is possible to improve web traffic prediction systems while providing a more detailed analysis of business information.|
|Deep learning and time series analysis application on traffic flow forecasting| |Journal of Theoretical and Applied Information Technology|2022|deep learning and time series analysis|traffic flow forecasting| |SARIMAX RNN  with LSTM CNN with LSTM|Hourly Traffic Flow from | |Sarimax R²: 45% RMSE: 1806.18 MAE: 1280.46 LSTM Model Manual Payment: R²: 90.02% RMSE: 60.68 MAE: 40.70 Electronic Toll: R²: 79.02% RMSE: 36.49 MAE: 23.13 CNN Model Manual Payment: R²: 95.06% RMSE: 40.29 MAE: 28.21 Electronic Toll: R²: 87.84% RMSE: 28.29 MAE: 16.93 | |Hourly Traffic at Toll Station for last 4 years| |Need Hybrid model  Underutilization of DL |Development of hybrid model, Handling complex temporal variations, Applications in different places| | |
|Short Term Traffic Flow Forecasting by Time Series Analysis| |Proceedings of International Conference on Planning, Architecture and Civil Engineering, Rajshahi University of Engineering & Technology, Rajshahi, Bangladesh.|2019|Traffic flow forecasting using time series analysis|short-term traffic flow forecasting| |ARIMA|Data from Dublin Airport Link Road after interval of 10 minutes| |Mean Absolute Relative Error (MARE) of 8.51%  Mean Absolute Percentage Prediction Error (MAPPE) of 2.19%  R-squared value was 0.98| |Dublin Airport link road in Ireland| |Exploration of ARIMA model for semi-seasonal traffic data and to improve forecast accuracy|Implementation of Seasonal ARIMA Exploring other Time series model Incorporting external factor Longer data collection period| | |
|An Overview Based on the Overall Architecture of Traffic Forecasting| |Data Science and Engineering|2024|Traffic Forecasting|Short Term and Long Term Prediction of traffic | |Bi-Directional and Uni Directional LSTM, Gated Recurrent Unit(GRU), SVM|Temporal Features (Periodic, Trend, Daily, Hourly) | |Improved Accuracy (Not mentioned explicitly)| |TaxiBJ HZMetro SHSpeed Metr-LA| |Hetrogenous Data Multi-Task Perdiction  Model Interpretability |Large Scale Graph Based Dynamic Spatial Temporal Modeling Explanability Technique Multi Source Data Fusion| | |
|Hybrid Deep Learning Models for Traffic Prediction in Large-Scale Road Networks| |Information Fusion|2022|Intelligent Transportation system,  Traffic Predicition|Traffic prediction in large-scale road networks, focusing on improving the accuracy of predictions| |CNN GCN LSTM Temporal Convolutional Networks (TCNs) CNN with GCN LSTM and Transformer|Traffic Speed Spatial Data Temporal Data External Features| |Page 44 Table| |Metr-La Loop-Seattle Pems-Bay| |Self Supervised Learning Graph Based Forecasting Hetrogenous Data fusion|Large Model Integration Knowledge Guided Traffic Forcasting Self Supervised based traffic forecasting | | |
|Machine Learning and Statistic Predictive Modeling for Road Traffic Flow| |Journal of Traffic and Transportation Management|2021|Intelligent Transportation system,  Traffic Predicition|Issue of road traffic congestion and aims to forecast day-by-day traffic flow| | Multilayer Perceptron Artifical Neural Network SARIMA Support Machine regression (SMOreg)|Calender information Traffic Information| |MLP and SARIMA shows the predicted output SMOReg RMSE 0.16 MAE 0.09 MSE 0.025| |Morroco | |External Condition Multi Source Data Real Time Forecasting Benchmarking and Comparision|Incorporting external condition Utilizing multi-source info Exploring advance techniques| | |
|Short-Term Traffic Flow Prediction for Urban Road Sections Based on Time Series Analysis and LSTM_BILSTM Method| |IEEE Transactions on Intelligent Transportation Systems|2021| |real-time and accurate prediction of short-term traffic flow to improve traffic efficiency and safety in urban road sections| |LSTM and BiLSTM|Traffic Flow Time Date Weather condition| |MAE = 12.36 RMSE = 16.72 R2 = not mentioned but higher in evaluated model| |Ningbo dataset PeMS Data| |Doesn’t focus on other external influence  Need to predict under multiple variations. |Predicting traffic flow on weekend and comparing it with daily  Considering different weather condition  Enhance accuracy and acceptibility| | |
|Hyper-Flophet: A Neural Prophet-Based Model for Traffic Flow Forecasting in Transportation Systems| |Springer Nature|2021|Traffic Flow Prediction and Vehicular Ad Hoc Networks (VANETs)|traffic flow prediction in Vehicular Ad Hoc Networks| |Hyper-Flophet (Prophet & LSTM)  Real-Time Trend indentification Algorithm  Interactive LSTM  Future Regressor Component  Exponential Growth Algorithm|Historical traffic flow data  Network Mobility Feature  Event and Holiday Information| |RTI Algorithm MAE: 1.256442 RMSE: 1.577608 Smooth L1 Loss: 0.033382  Network Mobility Feature MAE: 1.198662 RMSE: 1.51187 Smooth L1 Loss: 0.032084  I-LSTM Integration MAE: 1.19836 RMSE: 1.509817 Smooth L1 Loss: 0.031954  Neural Prophet Model MAE: 2.985544 RMSE: 3.779646 Smooth L1 Loss: 0.006844  Hyper-Flophet Model MAE: 1.19836 RMSE: 1.509817 Smooth L1 Loss: 0.031954| |real-world Traffic Prediction Dataset| |Limited Integration of External Factors  Real-Time Data Processing Challenges  Handling Non-Linearity and Non-Stationarity  Evaluation with Diverse Datasets|Integration of More Features  Improved Prediction Models  Scalability and Adaptability  Real-Time Data Processing  Handling Unplanned Event| | |
|A Flow Feedback Traffic Prediction Based on Visual Quantified Features| |IEEE Transactions on Intelligent Transportation Systems|2023|Intelligent Transportation Systems, Traffic Flow Prediction|traffic flow prediction| |Visual Quantization Graph Convolution Method: LSTM GRU Temporal Convolution Method Reverse Graph Convolution with Forward Spatio-Temporal Features|Traffic Density Spatial and Temporal Features Visual Quantified Flow Indicator | | (MAE): 3.7   (RMSE): 4.8 (MAPE): 14.2%| | 3,500 images| |V-STF, aims to improve prediction accuracy during non-periodic peak hours by considering the impact of congested road conditions on traffic flow  better prediction models that can accurately forecast sudden|xplore the integration of additional visual features Investigate the application of the V-STF model in real-time traffic management systems  Conduct experiments with different deep learning architectures | | |
|Flophet: A Novel Prophet-Based Model for Traffic Flow Prediction in Vehicular Ad Hoc Networks| |Journal of Theoretical and Applied Information Technology|2023|Traffic flow prediction in Vehicular Ad Hoc Networks (VANETs)|Accurate realtime traffic flow prediction | |Prophet model LSTM model  LSTM with BiLSTM|Traffic flow data Time of the day Day of the week weather condition holiday info|Predicted traffic volume through graph|Mean Absolute Error Flophet MAE: 6.854 Neural Prophet MAE: 8.187 Smooth L1 Loss Flophet : 0.046 Neural Prophet: 0.0684| |Traffic Prediction Data from Keegle | |Handling Non-linear Spatio-temporal Dependencies  Incorporating External Factors  Detailed Trend Analysis  Integration of Network Mobility Features|Efficient neural network architecture Event and holiday componenet algorithm Future enhanement of flophet| | |
|Urban Traffic Flow Predictions with Impacts of Weather and Holidays| |Emerging Cutting-Edge Developments in Intelligent Traffic and Transportation Systems|2024|Traffic Flow Prediction with neural prophet|Missing data like weather and events using imputation method for the prediction of traffic flow| |Neural Prophet Model|Traffic flow data Day of the week weather condition holiday info|Predicted traffic volume through graph|MAPE: 13.94 MAE: 19.73 RMSE: 27.49| |NA| |Enhance Accuracy Combination of model| | | |
|Traffic Flow Forecast through Time Series Analysis Based on Deep Learning| |IEEE Transactions on Intelligent Transportation Systems|2020|Intelligent Traffic Systems (ITS), specifically focusing on traffic flow forecasting|To improve the forecasting accuracy using deep learning techniques | |LSTM|Traffic Volume and Time Interval|Predicted traffic volume through graph| | |OpenITS| |Enhance accuracy  Better Model   Multiple inputs like weather, holidays|To predict flow under various conditions| | |
|Forecasting Traffic Flow Using Machine Learning Algorithms| |Engineering Procedding|2024|Traffic Flow |To predict using Machine learning algorithms| |decision trees, random forests, and gradient boosting,|Traffic Data and date|????| | |Document traffic data from camera| | |Better accuracy| | |
|An adaptive composite time series forecasting model for short‑term traffic flow| |Springer Open|2024|Short Term Traffic Flow|To predict short term traffic | |Long-Short-Combination L-B-LSTM|Historical traffic flow data  Weather Condition  Traffic Attribute  Spatial Features |12:05 PM - 12:10 PM 160  12:10 PM - 12:15 PM 170  12:15 PM - 12:20 PM 180  12:20 PM - 12:25 PM 200  12:25 PM - 12:30 PM 220  12:30 PM - 12:35 PM 210  12:35 PM - 12:40 PM 190  12:40 PM - 12:45 PM 175  12:45 PM - 12:50 PM 160  12:50 PM - 12:55 PM 150  12:55 PM - 1:00 PM 140 |L-B-LSTM  L MAPE: 1.25 RMSE: 1.06 MAE: 0.73 S MAPE: 4.41 RMSE: 0.54 MAE: 0.41 C F1score 0.98| |Qingdao Dataset  PeMS08 Dataset| |Differentiate between congested and non-congusted traffic  Limited Exploration of Traffic Data Attributes  Need for Adaptive Frameworks|Integration with Spatial Structures  Advanced Traffic Attribute Classification  Further Model Enhancement| | |
|Short-Term Traffic Speed Forecasting Using a Deep Learning Method Based on Multitemporal Traffic Flow Volume| |IEEE|2022|Traffic Speed Forecasting|To predict Traffic Speed forecasting using Multiple Forecasting Model| |LSTM, Back Proporgation, Classification and Regression trees, Support Vector Machine Kalman Filter|Traffic Volume, Speed, Date|Predicted speed|Multiple values on Pg No. 9| |Collected from Bejing Third Ring Expressway| |To ehnace the model   Fitting it on different datasets|Use of different models| | |
|Traffic Flow Forecast Through Time Series Analysis Based on Deep Learning| |IEEE|2020|Traffic Forecasting|To forecasting traffic flow | |BPNN, LSTM, ARIMA|Traffic Volume |Predicted traffic | | |Downloaded from OpenITS,| | | | | |
|Traffic Flow Prediction Model Based on LSTM with Finnish Dataset| |IEEE|2021|Short Term Traffic Forecasting|To forecasting traffic flow | |LSTM, GRU, Stacked Autoencoders |Traffic Volume |Predicted Graphically|LSTM:  MAE: 6.8284 RMSE: 9.4587 MAPE: 26.415% R2: 0.930711  GRU:  MAE: 7.697840 RMSE: 11.128345 MAPE: 28.142879% R2: 0.904092  SAEs:  MAE: 7.351850 RMSE: 7.351850 MAPE: 25.162347% R2: 0.911984| |Finnish dataset| |Model Complexity and Performance  Generalization across Different Datasets  Limited Exploration of other models|Model Optimization  Hybrid Model  Real-Time Prediction| | |
|Few-shot Time-Series Forecasting with Application for Vehicular Traffic Flow| |IEEE|2022|Forecasting Traffic|Forecasting using Few-Short Forecasting Model| |Few-Shot Forecasting Models LSTM  Difference FSFM Siamese FSFM Nearst Neighbour Model (NNM)|Traffic Volume|Predicted Graphically|Difference FSFM: MAE: 0.03833 Siamese FSFM: MAE: 0.03727 NNM: MAE: 0.04380| |PeMS| |Limited Exploration of Model Architectures  Univariate Analysis  Lack of Contextual Features|Model Complexity and Calibration  Incorporating Multivariate Data  Longer Forecast Horizons  Generalization Across Datasets| | |
|Multivariate Time Series Traffic Forecast with Long Short Term Memory based Deep Learning Model| |IEEE|2020|Forecasting Traffic|To forecast using multivariate and univariate features. | |ARIMA, Kohonen ARIMA, Subset ARIMA, ARIMAX, SARIMA Univariate LSTM Multivariate LSTM|Traffic Volume Day Date Time Weather|Average vehicle speed and vehicle occupancy rate|Univariate LSTM MSE: 111.04 RMSE : 10.8 MAE: 7.3 Multivariate LSTM  MSE: 96.3 RMSE : LSTM: 9.8 MAE: 6.6| |California Transportation Agencies (CalTrans) Performance Measurement System (PeMS)| |Univariate vs. Multivariate Models  Univariate vs. Multivariate Models  Comparative Analysis|Exploration of Additional Multivariate Features  Advanced Deep Learning Architectures  Real-Time Traffic Prediction  | | |
|A Short-Term Traffic Flow Prediction Model Based on an Improved Gate Recurrent Unit Neural Network| |IEEE|2022|Traffic Forecasting|To forecast short term traffic| |improved Gate Recurrent Unit (GRU) neural network mode bidirectional GRU (Bi-GRU) Rectified Adaptive Moment Estimation (RAdam) optimizer|vehicle flow, average occupancy and speed|Graphical description|LSTM:  MAE: 8.837552 MSE: 134.633420 RMSE: 11.603164 MAPE: 0.327107 R2: 0.917120 Bi GRU:  MAE: 7.196944 MSE: 96.087076 RMSE: 9.802402 MAPE: 0.172915 R2: 0.940849  SAEs:  MAE: 7.837623 MSE: 110.101286 RMSE: 10.492916 MAPE: 0.175333 R2: 0.932222| |Pems| |more accurate short-term traffic flow predictions  GRU models have potential, they are less studied compared to LSTM models in the context of traffic flow prediction|Integrating External Factors  Exploring Corelation between multiple factors| | |
| M-B-LSTM Hybrid NetworkShort-Term Traffic Flow Forecasting Method With| |IEEE|2022|Traffic Forecasting|Forecasting Short Term Traffic| |MB LSTM Deep Bidirectional LSTM (DBLSTM)|Sequence of traffic flow and time [xt−n, xt−n+1, · · · , xt−1, xt]|Forcasted traffic x̂t+1|See page No 8 for the details MB LSTM MRE: 7.60 MAE: 12.439 RMSE: 18.676 | |Changchun Datase  I90 Dataset| | |improving the model's robustness and generalization  Exploring the integration of more diverse data sources  Using other models| | |
|Short-term Traffic Flow Prediction Based on Recurrent Neural Network| |IEEE|2021|Traffic Forecasting|Forecasting Short Term Traffic| |LSTM, GRU and SAEs,|Traffic rate, date and time|Forecasted Traffic|EVS Road2: LSTM = 0.85, GRU = 0.84, SAEs = 0.84 Road1: LSTM = 0.89, GRU = 0.89, SAEs = 0.87 MAPE Road1: LSTM = 24.3, GRU = 27.4, SAEs = 29.3 MAE Road1: LSTM = 6.17, GRU = 6.18, SAEs = 9.93 MSE Road3: LSTM = 99.9, GRU = 107, SAEs = 111 RMSE Road2: LSTM = 8.02, GRU = 8.31, SAEs = 13.3 R2 Road1: LSTM = 0.89, GRU = 0.89, SAEs = 0.75| |Collected from Huangshan Road| |To find better prediction scheme|To integrate multiple sources| | |
|A Queue Hybrid Neural Network with Weather Weighted Factor for Traffic Flow Prediction| |IEEE|2021|Traffic Forecasting|To forecast Weather Weighted Factor for Traffic Flow Prediction| |queue hybrid neural network (QHNN) model based on LSTM and GRU|Traffic Data along with weather conditions|Forecasted Traffic|                     MAE        RMSE LSTM          16.964     24.008 Bi-LSTM     16.868     23.886 GRU           16.939     23.957  T-LSTM      15.124     21.373  T-Bi-LSTM 15.060     21.382  T-GRU       15.211      21.711  QHNN      14.501      20.429| |collected by Regional Trasportation Management Center (RTMC)| | |Optimize QHNN to further improve its feature extraction capability  Use deep learning method to analyze and dispose multi-dimensional data.| | |
|Short-Term Load Forecasting and Associated Weather Variables Prediction Using ResNet-LSTM  Based Deep Learning| |IEEE|2022|Power Load Forecasting|To forecaste load with weather variable| |ResNet LSTM|Weather Conditions Day of the week Load related variable|Power Load Forecasting|MAPE MLR: 0.769 LSTM: 0.822 CNN: 0.815 ResNet: 0.753 CNN LSTM: 0.830 ResNet-LSTM: 0.597  RMSE MLR: 84.307 LSTM: 89.396 CNN: 86.494 ResNet: 79.653 CNN LSTM: 89.264 ResNet-LSTM: 62.933  MAE MLR: 69.938 LSTM: 65.982 CNN: 67.747 ResNet: 62.488 CNN LSTM: 69.501 ResNet-LSTM: 49.301| |load dataset from Queensland, Australia,| |Limitations of Existing Models  Complexity in Data Characteristics:  Need for Enhanced Feature Extraction|Improving Model Architecture  Exploration of Additional Variables  Real-Time Forecasting and Scalability  Addressing Computational Efficiency| | |
|Day-Ahead Solar Irradiation Forecasting Utilizing Gramian Angular Field and Convolutional Long Short-Term Memory| |IEEE|2020|Renewable energy forecasting, specifically day-ahead solar irradiation forecasting.|The challenge of forecasting day-ahead solar irradiation| |Gramian Angular Field (GAF) and Convolutional Long Short-Term Memory (ConvLSTM)|Univariate time-series dataset|day-ahead forecasted GHI values|MAE (Mean Absolute Error): ConvLSTM: 0.1430 ARIMA: 0.1557 CNN-LSTM: 0.1635  RMSE: ConvLSTM: 0.2044 ARIMA: 0.2082 CNN-LSTM:0.2266  R Squared: ConvLSTM: 0.6944 ARIMA: 0.6455 CNN-LSTM: 0.5845| |Global Horizontal Irradiation (GHI) dataset from Fuhai, Taiwan,| |Data Dependency in Deep Learning Methods  Limited Application of ConvLSTM for Time-Series Forecasting:   Benchmarks and Empirical Evidence:|Exploring Multivariate Datasets  Hybrid Models  Real-Time and Very Short-Term Forecasting:  Transfer Learning:  | | |
...
| Final Synopsis| Defance Date| Research Questions|Research Gap|Dataset|Notebook|Blog|Diagram| Final Thesis|
|---|---|---|---|---|---|---|---|---|
|[Synopis file](https://github.com/hussain0048/Research-Work/blob/main/Synopsis%20V%202.0%20.docx)| **June-14-2024** | Q1: How to road traffic prediction can be enhanced by using the Hybrid approach of Deep Learning time series model and temporal features?
Q1.1: How does combining Time Series Analysis along with Deep Learning models and incorporation of temporal features impact the forecasting accuracy of the model?
