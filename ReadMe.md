...
|---|---|---|---|---|---|---|
|[**🌐1- Identifying Interrelated Factors of Fatal and Injury Traffic Accidents Using Association Rules**](https://dergipark.org.tr/en/download/article-file/3379204) | 2023  | What are the Interrelated Factors of Fatal Injury | Support, Confidence and Lift | NA | This study does not provide any information in connection with level of injury severity along with property damage only accidents  |Taking notes information is incorect it mean in which pertion of thesis or paper it will help you|
