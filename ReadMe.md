...
**Examples:**
- The ice shelves in the Antarctic Peninsula have been affected by climate change (Rasmussen, 2021).
...
**Example:**  
Limer, E. (2013, October 1). Heck yes! The first free wireless plan is finally here. Gizmodo. [https://gizmodo.com/heck-yes-the-first-free-wireless-plan-is-finally-here](https://gizmodo.com/heck-yes-the-first-free-wireless-plan-is-finally-here)

## How to Cite a Book in APA

### In-text citation
- **Parenthetical structure:** (Author Last Name, Publication Year)
- **Narrative structure:** Author Last Name (Publication Year)

**Examples:**
- Parenthetical citation: (Henry, 2009)
...
**Example:**  
James, H. (2009). *The ambassadors*. Serenity Publishers.
...
- **2 authors:** List both authors separated by a comma and use an ampersand (&) before the last author's name.
- **3 to 20 authors:** Separate author names with commas and use an ampersand (&) before the final author’s name.
- **21+ authors:** List the first 19 names separated by commas, then add an ellipsis (...) followed by the final author’s name.
...
#### Structuring Journal Article Titles
- Only capitalize the first letter of the first word of the article.
- Do not italicize or underline the title.
- End with a period.

#### Structuring the Journal Name
- Capitalize the journal name as it appears in publication.
- Italicize the name and follow it with a comma.

#### Structuring Volume and Issue Numbers
- Italicize the volume number.
- Place the issue number in parentheses without italics, and follow with a period.

#### Structuring URLs and DOIs
- Place the URL or DOI after the volume and issue number.
- Use a DOI if available, formatted as: `https://doi.org/xxxx`
- If a DOI is available, it should be included regardless of the version viewed.

**Example:**  
Yu, H., & Leadbetter, J. R. (2020, July 15). Bacterial chemolithoautotrophy via manganese oxidation. *Nature, 583*(7816), 453–458. [https://doi.org/10.1038/s41586-020-2468-5](https://doi.org/10.1038/s41586-020-2468-5)

**Reference Page Structure:**  
Author’s last name, Author’s first initial. Author’s middle initial. (Year, Month Date Published). Article title. *Journal Name, Volume*(Issue), page number(s). DOI/URL

**Example:**  
Jacoby, W. G. (1994). Public attitudes toward government spending. *American Journal of Political Science, 38*(2), 336-361. [https://doi.org/10.2307/2111407](https://doi.org/10.2307/2111407)
...
**Example:**  
Fearon, J. D., & Laitin, D. D. (2003). Ethnicity, insurgency, and civil war. *American Political Science Review, 97*(01), 75. [https://doi.org/10.1017/S0003055403000534](https://doi.org/10.1017/S0003055403000534)
...
### Reference Page
**Structure:**  
Author's last name, First initial. (Publication or creation date). *Title of image* [Type of media]. Name of publisher, museum, or university. URL

**Example:**  
Stone, M. (2020). [Picture of fireflies at night in Congaree National Park] [Photograph]. National Geographic. [https://www.nationalgeographic.com/animals/2020/06/synchronous-fireflies-rare-look-congaree-national-park/#/fireflies-congaree-1994.jpg](https://www.nationalgeographic.com/animals/2020/06/synchronous-fireflies-rare-look-congaree-national-park/#/fireflies-congaree-1994.jpg)
###
